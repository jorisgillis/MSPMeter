...
public class CumulationAndResamplingTest {
	 ...
	 */
	public CumulationAndResamplingTest( DataCube dataCube, DataCube accumulated, int numberOfTokens ) {
...
//			System.out.println(resampled[i]);
	...
	public static Collection<Object[]> setUp() {
		...
		HashMap<String, HashMap<String, HashMap<String, Integer>>> cumulated1 = new HashMap<String, HashMap<String,HashMap<String,Integer>>>();
		...
		// accumulation
		cumulated1.put("0;01", new HashMap<String, HashMap<String,Integer>>());
		
		cumulated1.get("0;01").put("have", new HashMap<String, Integer>());
		cumulated1.get("0;01").put("be", new HashMap<String, Integer>());
		
		cumulated1.get("0;01").get("have").put("inf", 1);
		cumulated1.get("0;01").get("be").put("1pp", 2);
		
		cumulated1.put("0;02", new HashMap<String, HashMap<String, Integer>>());
		
		cumulated1.get("0;02").put("have", new HashMap<String, Integer>());
		cumulated1.get("0;02").put("be", new HashMap<String, Integer>());
		
		cumulated1.get("0;02").get("have").put("inf", 2);
		cumulated1.get("0;02").get("be").put("1ps", 3);
		cumulated1.get("0;02").get("be").put("1pp", 2);
		cumulated1.get("0;02").get("be").put("inf", 2);
